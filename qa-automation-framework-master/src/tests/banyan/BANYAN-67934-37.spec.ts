...
const testCaseID = "BANYAN-67934-37";
test.describe.configure({ retries: 1 });
test.describe.serial("LTL Quote - Banyan Rating Engine for pct uplift", { tag: ['@tporegression', '@smoke'] }, () => {
    ...
    test("Case Id: 67934 - LTL Quote - Banyan - Quotes with customer configured rates PCT uplift",
        { tag: ['@tporegression', '@banyan', '@p44', '@ltlquote'] }, async () => {
            pages.logger.info("Starting LTL Quote - Banyan - Quotes with customer configured rates PCT uplift");
    ...
    test("Case Id: 67937 - LTL Quote - Banyan - Create load from quotes with customer rate PCT uplift and e-dispatch",
