...
test.describe.serial("LTL Quotes - Mode Rating Engine - Quote from Mode (TRITAN)", { tag: ['@tporegression', '@smoke'] }, () => {
    ...
    test("Case Id: 67954 - LTL Quotes - Mode Rating Engine - Create load from quote", { tag: ['@tporegression', '@banyan', '@p44', '@ltlquote'] }, async () => {
        const testCaseID = "BANYAN-67954";
    ...
    /**
 * Test Case ID: BANYAN-67955
 * Description: LTL Quotes - Mode Rating Engine - eDispatch load
 * @author Aniket Nale
 * @created 18-Nov-2025
 */

    test("Case Id: 67955 - LTL Quotes - Mode Rating Engine - eDispatch load", { tag: ['@tporegression', '@banyan', '@p44', '@ltlquote'] }, async () => {
        const testCaseID = "BANYAN-67955";
        testData = dataConfig.getTestDataFromCsv(dataConfig.banyanData, testCaseID);
