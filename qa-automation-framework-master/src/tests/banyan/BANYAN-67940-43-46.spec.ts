...
const testCaseID = "BANYAN-67940-43-46";
test.describe.configure({ retries: 1 });
test.describe.serial("LTL Quote with Accessorials - Banyan - flat uplift", { tag: ['@tporegression', '@smoke'] }, () => {
    ...
    test("Case Id: 67940 - LTL Quote with Accessorials - Banyan - Quotes with customer configured rates flat uplift",
        { tag: ['@tporegression', '@banyan', '@p44', '@ltlquote'] }, async () => {
            pages.logger.info("Starting LTL Quote with Accessorials - Banyan - Quotes with customer configured rates flat uplift");
    ...
    test("Case Id: 67943 - LTL Quote with Accessorials - Banyan - Create load from quotes with customer rate flat uplift",
    ...
    test("Case Id: 67946 - LTL Quote with Accessorials - Banyan - eDispatch load",
