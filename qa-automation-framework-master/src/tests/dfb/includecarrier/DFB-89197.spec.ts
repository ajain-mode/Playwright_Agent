...
/**
 * Test Case: DFB-89197 - Automatically post a load to the TNX for a single included carrier not on a waterfallNumber of included carriers = Minimum number (1)
.* @author Deepak Bohra
 * @date 08-Jan-2026
 */
const testcaseID = "DFB-89197";
...
test.describe
  .serial("Automatically post a load to the TNX for a single included carrier not on a waterfallNumber of included carriers = Minimum number (1).", () => {
  ...
  test(
    "Case Id: 89197 - Automatically post a load to the TNX for a single included carrier not on a waterfallNumber of included carriers = Minimum number (1)).",
