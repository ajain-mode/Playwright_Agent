...
test.describe.serial('Case ID: 25056-61638 - User should be able to search a customer and click on Create TL NEW link', () => {
  ...
  test("Case Id: 25056 - Create a Non Tabular load for US location with default cargo value",
 ...
 test(
    "Case Id: 61638 -Enter a Bid for a Load posted manually to the TNX(load create through non tabular form).",
    { tag: "@smoke, @dfb ,@loadposting, @tporegression, @bidding" },
    async () => {
      test.setTimeout(WAIT.SPEC_TIMEOUT); 
