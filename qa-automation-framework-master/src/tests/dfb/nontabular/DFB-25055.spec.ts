...
const testcaseID = 'DFB-25055';
const testData = dataConfig.getTestDataFromCsv(
  dataConfig.dfbData,
  testcaseID
);
test.describe.configure({ retries: 1 });
test.describe('Case ID: 25055 - User should be able to search a customer and click on Create TL NEW link',{tag: ['@dfb', '@tporegression','@smoke','@fieldvalidation']}, () => {
  test('Create a Non Tabular load for Canadian location with specified cargo value', async ({ page }) => {
