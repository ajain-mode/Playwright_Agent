...
test.describe.serial('Case ID: 82753 - Enter a Bid for a Load auto posted to the TNX - 2(bid made by agent in btms) and load created through tabular form',{tag: ['@dfb', '@tporegression','@nontabular']}, () => {
  ...
  test("Case Id: 82753 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agent in btms) and load created through tabular form",
    { tag: "@dfb ,@loadposting,@tporegression,@autoposting,@bidding" },
     async () => {
