...
test.describe.serial("Case ID: 61637 - Enter a Bid for a Load posted manually to the TNX(load create through tabular form)", () => {
  ...
  test(
    "Case Id: 61637 - Create a load for United States Location for customer having cargo value as default.",
