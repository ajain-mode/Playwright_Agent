...
test.describe.serial('Case ID: 61650 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agent in btms) and load created through non tabular form',{tag: ['@dfb', '@tporegression','@bidding']}, () => {
  ...
  test("Case Id: 61650 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agent in btms) and load created through non tabular form",
