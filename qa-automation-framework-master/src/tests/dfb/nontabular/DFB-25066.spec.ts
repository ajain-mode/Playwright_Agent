...
const testcaseID = 'DFB-25066';
const testData = dataConfig.getTestDataFromCsv(
  dataConfig.dfbData,
  testcaseID
);

test.describe('Case ID: 25066 - Verify that a load is created and displayed in edit mode having the expected results specified', { tag: ['@smoke','@dfb','@tporegression','@greenscreen'] }, () => {
  test('Create a Non Tabular load for Canadian location with default Cargo Value with Green Screen Validation, confidence level below 76', async ({ page }) => {
