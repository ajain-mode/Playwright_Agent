...
/**
 * Test Case: DFB-89168 - Automatically post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).
 * @author Parth Rastogi
 * @date 09-Dec-2025
 */

const testcaseID = "DFB-89168";
...
test.describe("Automatically post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).", () => {
  ...
  test(
    "Case Id: 89168 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load create through the Non Tabular form).",
