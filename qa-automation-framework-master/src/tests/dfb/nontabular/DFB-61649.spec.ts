...
test.describe.serial('Case ID: 61649 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agent in btms) and load created through tabular form',{tag: ['@dfb', '@tporegression','@bidding']}, () => {
 ...
 test(
    "Case Id: 61649 - Create a load for United States Location for customer having cargo value as default.",
