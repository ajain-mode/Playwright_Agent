...
test.describe.serial('Case ID: 82754 - Enter a Bid for a Load auto posted to the TNX - 2(bid made by agent in btms) and load created through non tabular form',{tag: ['@dfb', '@tporegression','@nontabular']}, () => {
  ...
  test("Case Id: 82754 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agent in btms) and load created through non tabular form",
    { tag: "@smoke, @dfb ,@loadposting, @tporegression,@bidding,@autoposting" },
     async () => {
