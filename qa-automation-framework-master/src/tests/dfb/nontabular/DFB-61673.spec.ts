...
/**
 * Test Case: DFB-61673 - Post a load to the TNX that is only visible to carriers selected for the Include Carriers field on the load(load create through tabular form).
 * @author Parth Rastogi
 * @date 17-Nov-2025
 */

const testcaseID = "DFB-61673";
...
test.describe.serial("Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create through tabular form)", () => {
  ...
  test(
    "Case Id: 61673 - Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create through tabular form).",
