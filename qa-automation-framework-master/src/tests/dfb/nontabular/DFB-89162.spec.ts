...
/**
 * Test Case: DFB-89162 - Manually post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).
 * @author Parth Rastogi
 * @date 04-Dec-2025
 */

const testcaseID = "DFB-89162";
...
test.describe("Manually post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).", () => {
  ...
  test(
    "Case Id: 89162 - Manually post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).",
    { tag: "@smoke, @dfb, @tporegression, @manualposting, @waterfall" },
    async () => {
      ...
      await test.step("Cancel the load in BTMS", async () => {
