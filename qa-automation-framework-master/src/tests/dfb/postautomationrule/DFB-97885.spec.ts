...
/**
 * Test Case: DFB-97885 - Verify that a new post automation rule is created for a NON EDI customer with Post to all Carriers upon completion of the Waterfall is checked.
 * @author Deepak Bohra
 * @date 16-Jan-2026
 */

const testcaseID = "DFB-97885";
...
test.describe(
  "Verify that a new post automation rule is created for a NON EDI customer with Post to all Carriers upon completion of the Waterfall is checked.",
  {
  ...
  () => {
    ...
    test("Case Id: 97885 : Verify that a new post automation rule is created for a NON EDI customer with Post to all Carriers upon completion of the Waterfall is checked.", {
