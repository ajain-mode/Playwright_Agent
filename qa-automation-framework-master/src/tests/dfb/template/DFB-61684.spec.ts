...
test.describe
  ...
  test(
    "Case Id: 61684 - Load is visible to carriers in Include Carriers; for non-included carriers, it’s visible with offer rate entered on load.",
    {
