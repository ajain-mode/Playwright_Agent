...
/**
 * Test Case: DFB-61678 - Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create through Template).
 * @author Parth Rastogi
 * @date 24-Nov-2025
 */

const testcaseID = 'DFB-61678';
...
test.describe('Case ID: 61678 - Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create through Template)', { tag: ['@smoke','@dfb', '@tporegression','@autoposting', '@waterfall'] }, () => {
