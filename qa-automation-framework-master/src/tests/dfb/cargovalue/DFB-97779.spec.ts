...
/**
 * Test Case: DFB-97779 - Manually post a TNX load with Cargo Value between $100,001 and $250,000.
 * @author Deepak Bohra
 * @date 22-Dec-2025
 */

const testcaseID = "DFB-97779";
...
test.describe
  ...
  test(
    "Case Id: 97779 - Manually post a TNX load with cargo value $100,001–$250,000, visible only to its configured 3‑carrier waterfall.",
    {
