...
/**
 * Test Case: DFB-97782 - Manually post a load to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier on a waterfall that has been configured on the loadNumber of included carriers
 * @author Parth Rastogi
 * @date 23-Dec-2025
 */
const testcaseID = "DFB-97782";
...
test.describe
  .serial("Manually post a load  to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier selected for the Include Carriers field", () => {
  ...
  test(
    "Case Id: 97782 - Manually post a load  to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier selected for the Include Carriers field.",
