...
/**
 * Test Case: DFB-97792 - Automatically post a TNX load with Cargo Value between $100,001 and $250,000
 * @author Deepak Bohra
 * @date 03-Dec-2025
 */

const testcaseID = "DFB-97792";
...
test.describe("Automatically post a TNX load with Cargo Value between $100,001 and $250,000.", () => {
  ...
  test(
    "Case Id: 97792 - Automatically post a TNX load with cargo value $100,001–$250,000, visible only to its configured 3‑carrier waterfall.",
    { tag: "@smoke,@dfb,@tporegression,@cargovalue"},
    async () => {
