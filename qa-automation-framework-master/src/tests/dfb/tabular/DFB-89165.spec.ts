...
/**
 * Test Case: DFB-89165 - Manually post a load to the TNX for all carriersNumber of included carriers = 0
 * @author Deepak Bohra
 * @date 05-Dec-2025
 */

const testcaseID = "DFB-89165";
...
test.describe.serial("Post a load to TNX without any included carrier.", () => {
  ...
  test(
    "Case Id: 89165 - Should successfully post a load without any carrier).",
    {
