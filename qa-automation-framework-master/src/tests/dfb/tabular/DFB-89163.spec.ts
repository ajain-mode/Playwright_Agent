...
/**
 * Test Case: DFB-89163 - Manually post a load to the TNX for a single included carrier on a waterfallNumber of included carriers = Minimum number (1)
 * @author Deepak Bohra
 * @date 05-Dec-2025
 */

const testcaseID = "DFB-89163";
...
test.describe
  ...
  test(
    "Case Id: 89163 - Should successfully post a load with exactly one included carrier(waterfall)).",
    {
