...
test.describe.serial("Create a tabular load  and post with enabled auto post minimum setting in office and post it TNX and validate the load status in DME and TNX applications.", () => {
  ...
  test(
    "Case Id: 61631 - Create a load for United States Location for customer having cargo value as default.",
    ...
    async () => {
      ...
      loadNumber = await loadCreationUtils.fillTabsAndCreateLoad(pages, testData);
