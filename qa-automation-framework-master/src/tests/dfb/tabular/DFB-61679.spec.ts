...
/*
 * Test Case: DFB-61668 - Post a load to the TNX that is only visible to carriers selected for the Include Carriers field and non Include carrier on the load(load create through tabular form).
 * @author Deepak Bohra
 * @date 17-Nov-2025
 */

const testcaseID = "DFB-61679";
...
test.describe
  ...
  test(
    "Case Id: 61679 - Verify TNX load posting for configured waterfall carriers and non-included carriers post waterfall).",
    {
