...
test.describe.serial("Create a load and post it to TNX and validate the load status in DME and TNX applications.", () => {
  ...
  test(
    "Case Id: 24953 - Create a load for United States Location for customer having cargo value as default.",
    { tag: "@dfb,@loadposting,@tporegression,@smoke,@matchbid" },
    async () => {
  ...
  test(
    "Case Id: 61625 -Manually post the load to TNX from DFB and validate the load status in DME and TNX applications.",
