...
/**
 * Test Case: DFB-61668 - Post a load to the TNX that is only visible to carriers selected for the Include Carriers field and non Include carrier on the load(load create through non tabular form).
 * @author Deepak Bohra
 * @date 14-Nov-2025
 */
const testcaseID = "DFB-61680";
...
test.describe
  ...
  test(
    "Case Id: 61680 - Verify TNX load posting for configured waterfall carriers and non-included carriers post waterfall).",
    {
