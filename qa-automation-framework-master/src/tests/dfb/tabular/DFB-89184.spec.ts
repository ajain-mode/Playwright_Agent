...
/**
 * Test Case: DFB-89184 - Match a load that is automatically posted to the TNX by an included carrier on a waterfall:
 * @author Deepak Bohra
 * @date 17-Dec-2025
 */

const testcaseID = "DFB-89184";
...
test.describe
  .serial("Match a load that is automatically posted to the TNX by an included carrier on a waterfall:", () => {
  ...
  test(
    "Case Id: 89184 - Post to all Carriers upon completion of the Waterfall- Offer Rate on the waterfall.",
    {
