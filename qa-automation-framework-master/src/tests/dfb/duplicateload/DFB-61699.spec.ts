...
/**
 * Test Case: DFB-61699 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load created by Duplicating the load from the existing load)
 * @author Parth Rastogi
 * @date 27-Nov-2025
 */

const testcaseID = "DFB-61699";
...
test.describe.serial("Case ID : DFB-61699 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load created by Duplicating the load from the existing load).", () => {
  ...
  test(
    "Case Id: 61699 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load created by Duplicating the load from the existing load).",
    { tag: "@smoke, @dfb, @tporegression, @offerrateonwaterfall, @autoposting" },
    async () => {
