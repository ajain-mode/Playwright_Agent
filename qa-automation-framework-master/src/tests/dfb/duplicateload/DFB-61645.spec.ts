...
test.describe("Case ID: 61645 - Enter a Bid for a Load auto posted to the TNX(load create by duplicating the existing load).", () => {
  ...
  test(
    "Case Id: 61645 - Enter a Bid for a Load auto posted to the TNX(load create by duplicating the existing load).",
