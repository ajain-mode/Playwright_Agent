...
/**
 * Test Case to Post a load to the TNX (load create by duplicating the load) and check include carrier present on the load is displaying the load created through duplicating the load.#
 * @author Deepak Bohra
 * @date 09-Nov-2025
 */

const testcaseID = "DFB-61663";
...
test.describe("Post a load to the TNX (load create by duplicating the load.", () => {
  ...
  test(
    "Case Id: 61663 - Validate the include carrier present on the load is displaying the load created through Duplicating the load.",
    { tag: "@dfb,@smoke,@tporegression, @includecarrier,@autoposting" },
    async () => {
