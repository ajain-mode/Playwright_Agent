...
test.describe.serial('Case ID: DFB-61652 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agaent in btms) and load created through EDI)', { tag: ['@smoke','@dfb', '@loadposting','@tporegression', '@bidding', '@manualposting'] }, () => {
