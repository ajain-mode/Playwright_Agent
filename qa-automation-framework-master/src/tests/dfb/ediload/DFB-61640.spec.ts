...
test.describe.serial('Case ID: 61640 - Enter a Bid for a Load posted manually to the TNX(load create through EDI)', { tag: ['@smoke','@dfb', '@loadposting','@tporegression', '@bidding', '@manualposting'] }, () => {
