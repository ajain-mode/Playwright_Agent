...
test.describe.serial('Case ID: DFB-61646 - Enter a Bid for a Load auto posted to the TNX(load create through EDI)', { tag: ['@dfb','@smoke', '@loadposting','@tporegression', '@bidding', '@autoposting'] }, () => {
