...
test.describe.serial('Case ID: DFB-82756 - Enter a Bid for a Load auto posted to the TNX - 2(bid made by agent in btms) and load created through EDI', { tag: ['@smoke','@dfb', '@tporegression','@loadposting', '@bidding', '@autoposting'] }, () => {
