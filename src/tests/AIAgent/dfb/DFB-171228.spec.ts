...
test.describe("Case ID: 171228 - Post automation rule match NON-EDI no stops", () => {
  ...
  test(
    "Case Id: 171228 - Post automation rule match NON-EDI no stops",
