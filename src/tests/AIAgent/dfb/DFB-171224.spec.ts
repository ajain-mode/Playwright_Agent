...
test.describe("Case ID: 171224 - Post automation rule match include carriers", () => {
  ...
  test(
    "Case Id: 171224 - Post automation rule match include carriers",
