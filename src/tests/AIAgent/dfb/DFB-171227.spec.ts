...
test.describe("Case ID: 171227 - Post automation rule match NON-EDI+stops", () => {
  ...
  test(
    "Case Id: 171227 - Post automation rule match NON-EDI+stops",
