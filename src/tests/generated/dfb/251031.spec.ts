...
/**
 * Test Case: 25103 - Verify that a message is displayed when a value is not entered for the Email for Notifications field on the CREATE NEW ENTRY form
 * @author AI Agent Generator
 * @date 2026-02-12
 * @category dfb
 */
const testcaseID = "25103";
...
test.describe.serial("Verify that a message is displayed when a value is not entered for the Email for Notifications field on the CREATE NEW ENTRY form", () => {
  ...
  test(
    "Case Id: 25103 - Verify that a message is displayed when a value is not entered for the Email for Notifications field on the CREATE NEW ENTRY form",
    {
      tag: "@aiteam,@dfb,@nontabular,@postautomationrules,@rulefieldvalidation,@notifications"
    },
    async () => {
      ...
      await test.step("Verify Expected Results", async () => {
        // Expected 1: A message is displayed relating 'Enter at least one email for notifications'
        // Verify message is displayed: A message is displayed relating 'Enter at least one email for notifications'
        const msgElement = sharedPage.locator("//*[contains(text(),'Enter at least one email for notifications')]");
        await expect(msgElement, "A message is displayed relating 'Enter at least one email for notifications'").toBeVisible({ timeout: 10000 });
      });
