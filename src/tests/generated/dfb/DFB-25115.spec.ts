  ...
  () => {
    ...
    test(
      ...
      await test.step("Step 9: Enter an invalid value for the DROP Zip/Postal Code field", async () => {
        // Enter invalid value for the DROP Zip/Postal Code
        const field_invalid_value_for_the_drop_zip_postal_code = sharedPage.locator("#form_invalid_value_for_the_drop_zip_postal_code, #invalid_value_for_the_drop_zip_postal_code, [name='invalid_value_for_the_drop_zip_postal_code']").first();
        await field_invalid_value_for_the_drop_zip_postal_code.waitFor({ state: "visible", timeout: WAIT.LARGE });
        await field_invalid_value_for_the_drop_zip_postal_code.fill(testData.invalidvaluefortheDROPZipPostalCode);
        console.log("Entered invalid value for the DROP Zip/Postal Code: " + testData.invalidvaluefortheDROPZipPostalCode);
      });
