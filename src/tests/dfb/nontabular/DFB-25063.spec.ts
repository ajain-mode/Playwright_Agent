...
const testcaseID = 'DFB-25063';
const testData = dataConfig.getTestDataFromCsv(
  dataConfig.dfbData,
  testcaseID
);

test.describe('Case ID: 25063 - User should be able to search a customer and click on Create TL NEW link', { tag: ['@smoke','@dfb','@tporegression','@greenscreen'] }, () => {
  test('Create a Non Tabular load for Canadian location with specified Cargo Value with Green Screen Validation', async ({ page }) => {
