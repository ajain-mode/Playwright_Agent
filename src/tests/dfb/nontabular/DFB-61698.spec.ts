...
/**
 * Test Case: DFB-61698 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load create through the Non Tabular form)
 * @author Parth Rastogi
 * @date 26-Nov-2025
 */

const testcaseID = "DFB-61698";
...
test.describe.serial("Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load create through the Non Tabular form).", () => {
  ...
  test(
    "Case Id: 61698 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load create through the Non Tabular form).",
