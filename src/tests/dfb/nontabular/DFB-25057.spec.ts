...
const testcaseID = 'DFB-25057';
const testData = dataConfig.getTestDataFromCsv(
  dataConfig.dfbData,
  testcaseID
);
test.describe.configure({ retries: 1 });
test.describe('Case ID: 25057 - User should be able to search a customer and click on Create TL NEW link',{tag: ['@smoke','@dfb', '@tporegression','@fieldvalidation']}, () => {
  test('Create a Non Tabular load for US location with specified cargo value', async ({ page }) => {
