...
const testcaseID = 'DFB-25062';
const testData = dataConfig.getTestDataFromCsv(
  dataConfig.dfbData,
  testcaseID
);

test.describe('Case ID: 25062 - User should be able to search a customer and click on Create TL NEW link', { tag: ['@smoke','@dfb','@tporegression','@greenscreen'] }, () => {
  test('Create a Non Tabular load for Canadian location with default Cargo Value with Green Screen Validation', async ({ page }) => {
