...
const testcaseID = 'DFB-25068';
const testData = dataConfig.getTestDataFromCsv(
  dataConfig.dfbData,
  testcaseID
);

test.describe('Case ID: 25068 - Verify that a load is created and displayed in edit mode having the expected results specified', { tag: ['@smoke','@dfb','@tporegression','@greenscreen'] }, () => {
  test('Create a Non Tabular load for US location with empty Cargo Value with Green Screen Validation, confidence level below 76', async ({ page }) => {
