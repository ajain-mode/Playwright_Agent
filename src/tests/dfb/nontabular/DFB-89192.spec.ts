...
/**
 * Test Case: DFB-89192 - Manually post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).
 * @author Parth Rastogi
 * @date 08-Jan-2026
 */

const testcaseID = "DFB-89192";
...
test.describe("Manually post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).", () => {
  ...
  test(
    "Case Id: 89192 - Manually post a load to the TNX for each included carrier on a waterfall. Number of included carriers-3 (load create through non tabular form).",
