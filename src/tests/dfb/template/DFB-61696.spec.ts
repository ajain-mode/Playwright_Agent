...
/**
 * Test Case: DFB-61691 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load create through the template)
 * @author Deepak Bohra
 * @date 05-Dec-2025
 */

const testcaseID = "DFB-61696";
...
test.describe
  .serial("Post load to TNX for waterfall carriers and remaining carriers after completion(load created through template).", () => {
  ...
  test(
    "Case Id: 61696 - Verify TNX load posting for configured waterfall carriers and non-included carriers post waterfall(when offer rate is entered on waterfall pop up)).",
    {
