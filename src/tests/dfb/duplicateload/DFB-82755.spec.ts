...
test.describe.serial('Case ID: 82755 - Enter a Bid for a Load auto posted to the TNX - 2(bid made by agent in btms) and load created by duplicating the existing load',{tag: ['@dfb', '@tporegression','@nontabular']}, () => {
  ...
  test("Case Id: 82755 - Enter a Bid for a Load posted manually to the TNX - 2(bid made by agent in btms) and load created by duplicating the existing load",
    { tag: "@smoke, @dfb ,@loadposting, @tporegression, @manualposting, @bidding" },
     async () => {
