...
/*
 * Test Case: DFB-61681 - Post a load to the TNX that is only visible to carriers selected for the Include Carriers field and non Include carrier on the load(load create by duplicating the load).
 * @author Deepak Bohra
 * @date 18-Nov-2025
 */

const testcaseID = "DFB-61681";
...
test.describe
  .serial("Post load to TNX for waterfall carriers and remaining carriers after completion(load created by duplicate method).", () => {
  ...
  test(
    "Case Id: 61681 - Verify TNX load posting for configured waterfall carriers and non-included carriers post waterfall).",
    {
      tag: "@dfb,@smoke,@tporegression, @waterfall,@manualposting",
    },
    async () => {
          ...
          const carriersData = [
            {
              ...
              values: [PRIORITY.PRIORITY_1, CARRIER_TIMING.TIMING_5, LOAD_OFFER_RATES.OFFER_RATE_1],
            },
            {
