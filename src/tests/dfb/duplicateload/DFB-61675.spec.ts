...
/**
 * Test Case: DFB-61675 - Auto Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create by duplicating the existing load).
 * @author Parth Rastogi
 * @date 19-Nov-2025
 */

const testcaseID = "DFB-61675";
...
test.describe.serial("Auto Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create by duplicating the existing load)", { tag: ['@dfb', '@tporegression', '@waterfall', '@autoposting'] },() => {
  ...
  test("Case Id: 61675 - Auto Post a load to the TNX for each carrier on a waterfall that has been configured on the load(load create by duplicating the existing load).",
    { tag: "@smoke,@dfb,@tporegression, @loadcreation, @autoposting" },
    async () => {
