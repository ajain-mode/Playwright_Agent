/**
 * Post a load to the TNX through Enable Auto Post with Minimum Fields feature that is only visible to carriers selected for the Include Carriers field on the load(load create through tabular form).
 * @author Deepak Bohra
 * @date 11-nov-2025
 */
...
test.describe
  .serial("Post a load to the TNX for validating include carrier functionality", () => {
  ...
  test(
    "Case Id: 61661 - Post a load to the TNX  through Enable Auto Post with Minimum Fields featurethat is only visible to carriers selected for the Include Carriers field on the load(load create through tabular form.",
