...
/**
 * Test Case: DFB-61691 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(Load create through the Tabular form)
 * @author Deepak Bohra
 * @date 01-Dec-2025
 */


const testcaseID = "DFB-61691";
...
test.describe
  .serial("Post load to TNX for waterfall carriers and remaining carriers after completion(load created by tabular method).", () => {
  ...
  test(
    "Case Id: 61691 - Verify TNX load posting for configured waterfall carriers and non-included carriers post waterfall).",
    {
    ...
    await test.step("Enter all details and create load", async () => {
      ...
      await test.step("Enter offer rate, save, and validate DFB form state in view mode", async () => {
        ...
        await pages.dfbIncludeCarriersDataModalWaterfall.enterWaterfallOfferRate(TNX.OFFER_RATE_3);
