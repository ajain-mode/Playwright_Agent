...
/**
 * Test Case: DFB-61700 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(load create through EDI)
 * @author Parth Rastogi
 * @date 28-Nov-2025
 */

const testcaseID = 'DFB-61700';
...
test.describe.serial('Case ID: DFB-61700 - Post a load to the TNX for:- each carrier on a waterfall that has been configured on the load- other non-included carriers after the completion of the waterfall - offer rate on waterfall(load create through EDI)', { tag: ['@smoke', '@dfb', '@tporegression', '@offerrateonwaterfall', '@autoposting'] }, () => {
