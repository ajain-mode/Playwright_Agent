...
test.describe
  ...
  test(
    "Case Id: 61694 - Validate the include carrier present on the load is displaying the load created through EDI.",
    {
      tag: "@dfb,@tporegression,@smoke,@offerrateonwaterfall,@manualposting",
    },
    async () => {
