...
test.describe
  .serial("Post a load to the TNX that is only visible to carriers selected for the Include Carriers field on the load(load create by through EDI).", () => {
  ...
  test(
    "Case Id: 61658 - Validate the include carrier present on the load is displaying the load created through EDI.",
