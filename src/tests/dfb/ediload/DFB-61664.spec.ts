...
/**
 * Test Case to Post a load to the TNX (load create by EDI) and check include carrier present on the load is displaying the load created through EDI.#
 * @author Deepak Bohra
 * @date 10-Nov-2025
 */

const testcaseID = "DFB-61664";
...
test.describe
  ...
  test(
    "Case Id: 61664 - Validate the include carrier present on the load is displaying the load created through EDI.",
