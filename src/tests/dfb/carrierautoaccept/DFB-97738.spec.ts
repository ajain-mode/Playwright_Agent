...
test.describe("Case ID: 97738 - Automatically book a load when it is manually posted(carrier auto accept)", () => {
  ...
  test(
    "Case Id: 97738 - Automatically book a load when it is manually posted(carrier auto accept)",
