/**
 * Test Case: DFB-97791 - Automatically post a TNX load with Cargo Value between $100,001 and $250,000.
 * @author Deepak Bohra
 * @date 29-Dec-2025
 */
...
test.describe
  .serial("Automatically post a TNX load with Cargo Value between $100,001 and $250,000", () => {
  ...
  test(
    "Case Id: 97791 - Automatically post a TNX load with cargo value $100,001–$250,000, visible only to its configured on include carrier",
