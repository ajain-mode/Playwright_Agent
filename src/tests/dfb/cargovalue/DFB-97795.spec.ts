...
/**
 * Test Case: DFB-97795 - Automatically post a TNX load with Cargo Value between $100,001 and $250,000.
 * @author Parth Rastogi
 * @date 22-Dec-2025
 */

const testcaseID = "DFB-97795";
...
test.describe
  .serial("Automatically post a load to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier on a waterfall that has been configured on the loadNumber of included carriers", () => {
    ...
    test(
      "Case Id: 97795 - Automatically post a load to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier on a waterfall that has been configured on the loadNumber of included carriers",
      {
