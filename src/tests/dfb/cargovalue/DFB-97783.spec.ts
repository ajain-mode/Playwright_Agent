...
/**
 * Test Case: DFB-97783 - Manually post a load to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier on a waterfall
 * @author Parth Rastogi
 * @date 27-Dec-2025
 */

const testcaseID = "DFB-97783";
...
test.describe
  .serial("Manually post a load to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier on a waterfall", () => {
  ...
  test(
    "Case Id: 97783 - Manually post a load to the TNX that:- has a Cargo Value of $100,001 to $250,000- is only visible to a single carrier on a waterfall that has been configured on the loadNumber of included carriers",
    {
