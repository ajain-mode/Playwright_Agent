...
/**
 * Test Case: DFB-97884 - Verify that a new post automation rule with a waterfall having the following configuration is created for a NON EDI customer.
 * @author Parth Rastogi
 * @date 16-Jan-2026
 */

const testcaseID = "DFB-97884";
...
test.describe(
  ...
  () => {
    ...
    test("Case Id: 97884 : Verify that a new post automation rule with a waterfall having the following configuration is created for a NON EDI customer.", {
