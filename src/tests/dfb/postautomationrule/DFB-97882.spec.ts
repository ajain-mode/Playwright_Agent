...
/**
 * Test Case: DFB-97782 - Verify that a new post automation rule is created for a NON EDI customer .
 * @author Deepak Bohra
 * @date 12-Jan-2026
 */

const testcaseID = "DFB-97882";
...
test.describe(
  ...
  () => {
    ...
    test("Case Id: 97882 : Verify that a new post automation rule is created for a NON EDI customer", {
      ...
      await test.step("Validate after edit the post automation rule information is correctly displayed", async () => {
        ...
        await pages.postAutomationRulePageEditEntryModal.validateCommodityText(POST_AUTOMATION_RULE.COMMODITY_VALUE);
