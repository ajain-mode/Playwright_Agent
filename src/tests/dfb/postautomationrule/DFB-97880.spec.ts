...
/**
 * Test Case: DFB-97880 - Verify that a new post automation rule is created for a NON EDI customer .
 * @author Parth Rastogi
 * @date 12-Jan-2026
 */

const testcaseID = "DFB-97880";
...
test.describe(
  ...
  () => {
    ...
    test("Case Id: 97880 : Verify that a new post automation rule is created for a NON EDI customer", {
