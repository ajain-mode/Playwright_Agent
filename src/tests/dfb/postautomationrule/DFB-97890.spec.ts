...
/**
 * Test Case: DFB-97890 - Verify that a new post automation rule is created for an EDI customer that does not use EDI ID locations.
 * @author Parth Rastogi
 * @date 12-Jan-2026
 */

const testcaseID = "DFB-97890";
...
test.describe(
  "Verify that a new post automation rule is created for an EDI customer that does not use EDI ID locations.",
  {
  ...
  () => {
    ...
    test("Case Id: 97890 : Verify that a new post automation rule is created for an EDI customer that does not use EDI ID locations.", {
      ...
      await test.step("Add the New post automation rule for a NON EDI customer", async () => {
        ...
        await pages.postAutomationRulePage.verifyCustomerPostAutomationRule(CUSTOMER_NAME.CUSTOMER_5);
